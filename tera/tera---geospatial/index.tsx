...
1.  **'analyze_context_space':** Use this tool for ALL risk, climate, or future planning queries.
    ...
    *   **Scale Selection:**
        *   **'neighborhood'**: Use for specific districts, small towns, or high-detail queries (approx 80m hex).
        *   **'city'**: Use for standard city-wide analysis (approx 250m hex).
        *   **'region'**: Use for provinces, states, or large areas (approx 1.5km hex).
